    ...
    <div>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
        ...
        <div style={{display: 'flex', gap: '1rem'}}>
           ...
           {/* Submit button uses the native form submission */}
        </div>
      </div>

      <div className={styles.tableContainer} style={{ background: 'var(--bg-secondary)', padding: '2rem' }}>
        <form action={createProduct} style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
          ...
          <fieldset style={{ border: 'none', padding: 0 }}>
            ...
            <div className="grid-cols-2">
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                ...
                <input type="text" name="name" className="input-base" required />
              </div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', marginTop: '1.5rem' }}>
              ...
              <textarea name="description" className="input-base" rows={4} required></textarea>
            </div>
          </fieldset>
          ...
          <fieldset style={{ border: 'none', padding: 0 }}>
            ...
            <div className="grid-cols-3">
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                <label>SKU *</label>
                <input type="text" name="sku" className="input-base" required />
              </div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                <label>Price ({currency.symbol}) *</label>
                <input type="number" name="price" step="0.01" className="input-base" required />
              </div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                <label>Quantity in Stock *</label>
                <input type="number" name="stock" className="input-base" required defaultValue="0" />
              </div>
            </div>
            <div className="grid-cols-3" style={{ marginTop: '1.5rem' }}>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                <label>Item Weight (kg) *</label>
                <input type="number" name="weight" step="0.01" className="input-base" required defaultValue="0.5" />
              </div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                <label>Discount Price ({currency.symbol})</label>
                <input type="number" name="discountPrice" step="0.01" className="input-base" placeholder="e.g. 19.99" />
              </div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                <label>Discount Expiry Date</label>
                <input type="date" name="discountEndDate" className="input-base" />
              </div>
            </div>
          </fieldset>
          ...
          <fieldset style={{ border: 'none', padding: 0 }}>
            ...
            <div className="grid-cols-3">
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                ...
                <input type="text" name="publisher" className="input-base" placeholder="e.g. O'Reilly Media" />
              </div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                <label>Edition</label>
                <input type="text" name="edition" className="input-base" placeholder="e.g. 2nd Edition" />
              </div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                <label>Edition Date</label>
                <input type="text" name="editionDate" className="input-base" placeholder="e.g. October 2023" />
              </div>
            </div>
            <div className="grid-cols-3" style={{ marginTop: '1.5rem' }}>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                <label>Dimensions</label>
                <input type="text" name="dimension" className="input-base" placeholder="e.g. 7 x 0.6 x 9 inches" />
              </div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                <label>ISBN-10</label>
                <input type="text" name="isbn10" className="input-base" placeholder="e.g. 1492056302" />
              </div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                <label>ISBN-13</label>
                <input type="text" name="isbn13" className="input-base" placeholder="e.g. 978-1492056300" />
              </div>
            </div>
          </fieldset>
           ...
           <fieldset style={{ border: 'none', padding: 0 }}>
            ...
            <div className="grid-cols-2">
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                ...
                <input type="url" name="imageUrl" className="input-base" placeholder="https://images.unsplash.com/..." />
              </div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                <label>Status</label>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', gridColumn: 'span 2', marginTop: '1rem' }}>
                ...
                <input type="url" name="videoUrl" className="input-base" placeholder="e.g. https://www.youtube.com/watch?v=ScMzIvxBSi4" />
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginTop: '1rem', gridColumn: 'span 2' }}>
                <input type="checkbox" name="fastDispatch" id="fastDispatch" style={{ width: '18px', height: '18px', cursor: 'pointer' }} />
